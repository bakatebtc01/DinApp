...
export const transfer = async (req: Request, res: Response) => {
    try {
        const { fromWalletId, toWalletId, amount, transactionType, description, referenceId } = req.body;
...
export const getTransactionHistory = async (req: Request, res: Response) => {
    try {
        ...
        const transactions = await ledgerService.getTransactionHistory(walletId, limit, offset);
...
export const getFxRate = async (req: Request, res: Response) => {
    try {
        ...
        const rate = await ledgerService.getCurrentFxRate(from as string, to as string);
