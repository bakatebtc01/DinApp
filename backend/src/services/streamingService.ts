 ...
 */
export const createSession = async (params: CreateSessionParams): Promise<LivestreamSession> => {
    const {
        creatorWalletId,
        creatorUserId,
        title,
 ...
 */
export const endSession = async (sessionId: string): Promise<LivestreamSession> => {
    const sql = `
    UPDATE livestream_sessions 
 ...
 * Get session by ID.
 */
export const getSession = async (sessionId: string): Promise<LivestreamSession | null> => {
 ...
 */
export const getLiveSessions = async (limit: number = 20): Promise<LivestreamSession[]> => {
    const sql = `
