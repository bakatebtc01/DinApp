...
router.post('/session', authLimiter, (req: Request, res: Response, next: NextFunction) => {
    streamingController.createSession(req, res).catch(next);
});

router.post('/session/:sessionId/start', authLimiter, (req: Request, res: Response, next: NextFunction) => {
    streamingController.startSession(req, res).catch(next);
});

router.post('/session/:sessionId/end', authLimiter, (req: Request, res: Response, next: NextFunction) => {
...
router.get('/creator/:creatorWalletId/sessions', (req: Request, res: Response, next: NextFunction) => {
...
router.post('/gift/send', authLimiter, (req: Request, res: Response, next: NextFunction) => {
    streamingController.sendGift(req, res).catch(next);
});

router.get('/session/:sessionId/gifts', (req: Request, res: Response, next: NextFunction) => {
